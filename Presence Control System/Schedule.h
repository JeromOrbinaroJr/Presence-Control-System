...
//	int m_endMinute;
//
//	WorkPeriod(std::string Id, int startHour, int startMinute, int endHour, int endMinute) :
//		m_id(Id), m_startHour(startHour), m_startMinute(startMinute), m_endHour(endHour), m_endMinute(endMinute) {}
//};
//
//class Schedule {
//public:
